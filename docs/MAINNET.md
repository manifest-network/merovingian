...
- Publish the permanent MCP endpoint to an authenticated registry namespace and public documentation. Configure Search Console when domain access is available. Keep OpenAPI, `/visit.md`, and `/llms.txt` aligned with the running API.
